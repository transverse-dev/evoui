...
`,u=c.default.div`
  ...
  cursor: pointer;
  user-select: none;
`;t.default=function(){const e=(0,d.useDispatch)(),t=(0,d.useSelector)(l.themeSelector);return(0,n.jsxs)(s,{children:[(0,n.jsxs)("div",{style:{display:"flex",alignItems:"center"},children:[(0,n.jsx)(u,{onClick:()=>{e((0,i.push)("/gettingstarted/introduction"))},children:"EvoUI"},void 0),(0,n.jsx)("div",{style:{marginRight:"16px"}},void 0),(0,n.jsx)("div",{style:{cursor:"pointer",fontSize:"0.8rem",fontWeight:"300"},onClick:()=>{e((0,i.push)("/gettingstarted/release"))},children:"v0.0.50"},void 0)]},void 0),(0,n.jsxs)("div",{onClick:()=>{"dark"===t?(localStorage.setItem("theme","light"),e({type:a.SET_THEME,payload:"light"})):(localStorage.setItem("theme","dark"),e({type:a.SET_THEME,payload:"dark"}))},style:{cursor:"pointer",fontSize:"0.8rem",fontWeight:"300",userSelect:"none"},children:[t," mode"]},void 0)]},void 0)}},4128:function(e,t,r){var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.Title1=t.Text=void 0;const n=o(r(9163));t.Text=n.default.div``,t.Title1=n.default.div``},8257:function(e,t,r){var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0});const n=r(4128),i=o(r(9163)).default.div`
  flex-grow: 1;
  padding: 32px 48px;
