(self["webpackChunk_transverse_evo_ui"] = self["webpackChunk_transverse_evo_ui"] || []).push([["commons"],{
...
/***/ "./node_modules/@transverse/evo-ui/dist/esm/index.js":
/*!***********************************************************!*\
  !*** ./node_modules/@transverse/evo-ui/dist/esm/index.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Root = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  padding: 12px;\n  border-radius: 6px;\n  font-size: 1.1rem;\n  text-align: center;\n  cursor: pointer;\n  user-select: none;\n  white-space: nowrap;\n\n  ", "\n\n  ", " \n  ", "\n\n  ", "\n"], ["\n  padding: 12px;\n  border-radius: 6px;\n  font-size: 1.1rem;\n  text-align: center;\n  cursor: pointer;\n  user-select: none;\n  white-space: nowrap;\n\n  ", "\n\n  ", " \n  ", "\n\n  ", "\n"])), function (props) {
    return (props.kind === undefined || props.kind === 'primary') &&
        "\n    background-color: ".concat(props.theme.evoui.colors.button.primaryBgColor, ";\n    box-shadow: ").concat(props.theme.evoui.colors.button.primaryShadow, ";\n    color: ").concat(props.theme.evoui.colors.button.primaryFgColor, ";\n    transition: 0.2s background-color;\n\n    &:hover {\n      background-color: ").concat(props.theme.evoui.colors.button.primaryHoverBgColor, ";\n    }\n  ");
}, function (props) {
    return props.kind === 'secondary' &&
        "\n    background-color: ".concat(props.theme.evoui.colors.button.secondaryBgColor, ";\n    box-shadow: ").concat(props.theme.evoui.colors.button.secondaryShadow, ";\n    text-decoration: underline;\n    color: ").concat(props.theme.evoui.colors.button.secondaryFgColor, ";\n  ");
}, function (props) {
    return props.kind === 'tertiary' &&
        "\n    background-color: ".concat(props.theme.evoui.colors.button.tertiaryBgColor, ";\n    box-shadow: ").concat(props.theme.evoui.colors.button.tertiaryShadow, ";\n    color: ").concat(props.theme.evoui.colors.button.tertiaryFgColor, ";\n  ");
}, function (props) {
    return props.disabled &&
        "\n    background-color: ".concat(props.theme.evoui.colors.button.disabledBgColor, ";\n    box-shadow: ").concat(props.theme.evoui.colors.button.disabledShadow, ";\n    color: ").concat(props.theme.evoui.colors.button.disabledFgColor, ";\n    text-decoration: initial;\n    pointer-events: none;\n    transition: initial;\n  ");
});
function Button(_a) {
    var disabled = _a.disabled, kind = _a.kind, onClick = _a.onClick, style = _a.style, children = _a.children;
    return (jsxRuntime.exports.jsx(Root, __assign({ disabled: disabled, kind: kind, onClick: disabled ? undefined : onClick, style: style }, { children: children }), void 0));
}
...
var dark = {
    colors: {
        button: {
            ...
            primaryShadow: "0 4px 18px 2px ".concat('#9f5cfa', "80"),
            primaryFgColor: '#ffffff',
            primaryHoverBgColor: '#7e46c9',
            secondaryBgColor: '#212121',
            secondaryShadow: "0 0 0 1px ".concat('#ffffff', " inset"),
            secondaryFgColor: '#ffffff',
            tertiaryBgColor: '#212121',
            tertiaryShadow: "1px 1px 4px ".concat('#212121', "c0"),
...
var light = {
    colors: {
        button: {
            ...
            secondaryShadow: "0 0 0 1px ".concat('#212121', " inset"),
            secondaryFgColor: '#212121',
            tertiaryBgColor: '#ffffff',
            tertiaryShadow: "1px 1px 4px ".concat('#212121', "40"),
...
function ThemeProvider(_a) {
    var _b = _a.darkMode, darkMode = _b === void 0 ? false : _b, children = _a.children, theme = _a.theme;
    return (jsxRuntime.exports.jsx(styled_components__WEBPACK_IMPORTED_MODULE_1__.ThemeProvider, __assign({ theme: __assign({ evoui: darkMode ? dark : light }, theme) }, { children: children }), void 0));
}
...
/* harmony import */ var lodash_isequalwith__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lodash.isequalwith */ "./node_modules/lodash.isequalwith/index.js");
...
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./actions */ "./node_modules/connected-react-router/esm/actions.js");
...
var createConnectedRouter = function createConnectedRouter(structure) {
  ...
  var ConnectedRouter = /*#__PURE__*/function (_PureComponent) {
    ...
    function ConnectedRouter(props) {
      ...
      _this.unsubscribe = store.subscribe(function () {
        ...
        if (isTimeTravelDebuggingAllowed && props.history.action === 'PUSH' && (pathnameInHistory !== pathnameInStore || searchInHistory !== searchInStore || hashInHistory !== hashInStore || !lodash_isequalwith__WEBPACK_IMPORTED_MODULE_2___default()(stateInStore, stateInHistory, stateCompareFunction))) {
  ...
  ConnectedRouter.propTypes = {
    store: prop_types__WEBPACK_IMPORTED_MODULE_5___default().shape({
      getState: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().func.isRequired),
      subscribe: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().func.isRequired)
    }).isRequired,
    history: prop_types__WEBPACK_IMPORTED_MODULE_5___default().shape({
      action: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string.isRequired),
      listen: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().func.isRequired),
      location: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().object.isRequired),
      push: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().func.isRequired)
    }).isRequired,
    basename: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string),
    children: prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_5___default().func), (prop_types__WEBPACK_IMPORTED_MODULE_5___default().node)]),
    onLocationChanged: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().func.isRequired),
    noInitialPop: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().bool),
    noTimeTravelDebugging: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().bool),
    stateCompareFunction: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().func),
    omitRouter: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().bool)
  };

  var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
      onLocationChanged: function onLocationChanged(location, action, isFirstRendering) {
        return dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_6__.onLocationChanged)(location, action, isFirstRendering));
      }
    };
  };

  var ConnectedRouterWithContext = function ConnectedRouterWithContext(props) {
    var Context = props.context || react_redux__WEBPACK_IMPORTED_MODULE_1__.ReactReduxContext;

    if (Context == null) {
      throw 'Please upgrade to react-redux v6';
    }

    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Context.Consumer, null, function (_ref) {
      var store = _ref.store;
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(ConnectedRouter, _extends({
        store: store
      }, props));
    });
  };
  ...
  ConnectedRouterWithContext.propTypes = {
    context: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().object)
  };
  return (0,react_redux__WEBPACK_IMPORTED_MODULE_1__.connect)(null, mapDispatchToProps)(ConnectedRouterWithContext);
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (createConnectedRouter);
...
/* harmony export */   "onLocationChanged": () => (/* binding */ onLocationChanged),
...
/* harmony export */   "onLocationChanged": () => (/* reexport safe */ _actions__WEBPACK_IMPORTED_MODULE_0__.onLocationChanged),
...
/* harmony export */   "routerActions": () => (/* reexport safe */ _actions__WEBPACK_IMPORTED_MODULE_0__.routerActions),
/* harmony export */   "routerMiddleware": () => (/* reexport safe */ _middleware__WEBPACK_IMPORTED_MODULE_1__["default"]),
/* harmony export */   "ConnectedRouter": () => (/* binding */ ConnectedRouter),
...
/* harmony export */   "createMatchSelector": () => (/* binding */ createMatchSelector)
/* harmony export */ });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (routerMiddleware);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (createConnectRouter);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (createSelectors);
...
//# sourceMappingURL=commons.be25519f24ea2a9e34b8.js.map