...
const Root = styled.div<loader.flealoader.RootPropsType>`
  display: flex;
...
export function FleaLoader({
  ...
  speed,
  margin,
}: loader.flealoader.FleaLoaderProps) {
  return (
    <Root
      scale={scale}
      color={color}
      ...
      speed={speed}
      margin={margin}>
      <div className={'evo-jump'}>
        <div className={'evo-rotate'}></div>
      </div>
      <div className={'evo-jump'}>
        <div className={'evo-rotate'}></div>
      </div>
